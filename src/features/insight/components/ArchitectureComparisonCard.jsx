...
export default function ArchitectureComparisonCard() {
    return (
        <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative">
            <div
                className="w-12 h-12 bg-[#E3EFEA] rounded-xl flex items-center justify-center mb-6">
            ...
            <p className="text-sm font-medium text-gray-500 mb-8 leading-relaxed">
                Berdasarkan eksperimen evaluasi model (Tabel 4.12), modifikasi menggunakan lapisan <strong className="text-[#042B1F]">Global
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#FAFAFA] p-6 rounded-2xl border border-gray-100">
                    ...
                    <p className="text-xs font-medium text-gray-500 leading-relaxed">Secara kuantitatif, GAP2D unggul
                        dengan peningkatan akurasi sebesar <strong className="text-[#042B1F]">5.15 poin</strong> dan kenaikan F1-Score
                        sebesar <strong className="text-[#042B1F]">6.6%</strong>.</p>
                </div>
                <div className="bg-[#FAFAFA] p-6 rounded-2xl border border-gray-100">
                    <h4 className="text-[#FF645A] font-bold mb-3 flex items-center gap-2">
                        <TrendingDown className="w-5 h-5"/> Penurunan Loss Drastis
                    </h4>
                    <p className="text-xs font-medium text-gray-500 leading-relaxed">Terjadi penurunan validation loss yang
                        sangat signifikan hingga <strong className="text-[#042B1F]">85%</strong>, membuktikan GAP2D jauh lebih stabil dan tahan terhadap indikasi overfitting.</p>
                </div>
                <div className="bg-[#FAFAFA] p-6 rounded-2xl border border-gray-100">
                    <h4 className="text-gray-600 font-bold mb-3 flex items-center gap-2">
                        <Clock className="w-5 h-5"/> Efisiensi Waktu
                    </h4>
                    <p className="text-xs font-medium text-gray-500 leading-relaxed">Walaupun menghasilkan kinerja
                        klasifikasi yang jauh lebih tinggi, rata-rata runtime per epoch tidak terpengaruh dan
                        tetap identik di kisaran <strong className="text-[#042B1F]">80 hingga 90 detik</strong>.</p>
                </div>
            </div>
        </div>
