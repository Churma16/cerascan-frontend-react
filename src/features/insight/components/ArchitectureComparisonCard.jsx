    ...
    return (
        <div className="bg-white border border-gray-100 rounded-lg p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative">
            ...
            <h3 className="text-xl font-black text-[#042B1F] mb-4">
                Keputusan Arsitektur: GAP2D vs Flattening
            </h3>
            <p className="text-sm font-medium text-gray-500 mb-8 leading-relaxed">
                Berdasarkan eksperimen evaluasi model (Tabel 4.12), modifikasi menggunakan lapisan{' '}
                <strong className="text-[#042B1F]">Global Average Pooling 2D (GAP2D)</strong>{' '}
                menunjukkan performa yang secara signifikan lebih unggul dibandingkan dengan
                pendekatan Flattening konvensional.
            </p>
                ...
                <table className="w-full text-left text-sm whitespace-nowrap">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        <tr className="bg-white transition-colors">
                            ...
                            <td className="px-6 py-5 font-mono text-[#042B1F] font-semibold">
                                0.3056
                            </td>
                            <td className="px-6 py-5 font-mono text-[#042B1F] font-semibold">
                                90.94%
                            ...
                            <td className="px-6 py-5 font-mono text-gray-500 font-medium">
                                ~80-89s
                            </td>
                        </tr>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#FAFAFA] p-6 rounded-2xl border border-gray-100">
                    ...
                    <p className="text-xs font-medium text-gray-500 leading-relaxed">
                        ...
                        <strong className="text-[#042B1F]">5.15 poin</strong> dan kenaikan F1-Score
                        sebesar <strong className="text-[#042B1F]">6.6%</strong>.
                    </p>
                </div>
                <div className="bg-[#FAFAFA] p-6 rounded-2xl border border-gray-100">
                    ...
                    <p className="text-xs font-medium text-gray-500 leading-relaxed">
                        ...
                        <strong className="text-[#042B1F]">85%</strong>, membuktikan GAP2D jauh
                        lebih stabil dan tahan terhadap indikasi overfitting.
                    </p>
                </div>
                <div className="bg-[#FAFAFA] p-6 rounded-2xl border border-gray-100">
                    ...
                    <p className="text-xs font-medium text-gray-500 leading-relaxed">
                        Walaupun menghasilkan kinerja klasifikasi yang jauh lebih tinggi, rata-rata
                        runtime per epoch tidak terpengaruh dan tetap identik di kisaran{' '}
