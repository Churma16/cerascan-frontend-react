    ...
    return (
        <CardWrapper>
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-8 md:gap-0 pt-8 border-t border-gray-50">
                ...
                <div>
                    <p className="text-[10px] font-extrabold text-gray-400 tracking-widest mb-2 uppercase">F1-Score</p>
                    <p className="text-4xl font-black text-[#FF645A]">0.910</p>
                </div>
                <div>
                    <p className="text-[10px] font-extrabold text-gray-400 tracking-widest mb-2 uppercase">Test Loss</p>
