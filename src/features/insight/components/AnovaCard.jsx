...
export default function AnovaCard() {
    return (
        <CardWrapper>
            ...
            <h3 className="text-xl font-black text-[#042B1F] mb-4">Analisis Pengaruh Parameter (ANOVA)</h3>

            <p className="text-sm text-gray-500 mb-8 leading-relaxed font-medium">
                Analisis ANOVA menunjukkan <strong className="text-[#042B1F] font-bold">Learning Rate</strong> merupakan
                faktor paling dominan yang memengaruhi jumlah epoch (p=0.58) dan Test Loss (p=0.28). Selanjutnya,{' '}
                <strong className="text-[#042B1F] font-bold">Batch Size</strong> berdampak signifikan pada Test Loss
                (p=0.24). Selain itu, terdapat{' '}
                <strong className="text-[#042B1F] font-bold">interaksi signifikan</strong> antara keduanya terhadap Loss
                Gap (p=0.017), dimana overfitting akibat LR tinggi diperburuk oleh Batch Size besar.
            </p>

            <div className="h-44 mt-auto">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={anovaFindings} layout="vertical" margin={{ top: 0, right: 20, left: 0, bottom: 0 }}>
