    ...
    return (
        <CardWrapper>
            <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Kemampuan Generalisasi Sangat Baik</h3>
                <p className="text-zinc-400 leading-relaxed max-w-lg">
                    Sistem terbukti sangat tangguh dalam mengklasifikasi 4 kelas cacat (retak, noda, goresan, normal)
                    dengan tingkat akurasi yang mengesankan.
                </p>
            </div>
            <div className="flex gap-8 mt-8 border-t border-[#262833] pt-6">
                <div>
                    <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-1">Akurasi Uji</p>
                ...
                <div className="hidden sm:block">
                    <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-1">Test Loss</p>
