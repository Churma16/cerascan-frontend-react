import { useCreatePlan } from '@/hooks/usePlan.js';
...
export default function AddPlanModal({ isOpen, onOpenChange }) {
                ...
                <div className="px-8 pt-8 border-b border-gray-100">
                    <AlertDialogHeader className="text-left">
                        ...
                        <AlertDialogDescription className="text-gray-500 font-medium mt-2">
                            Isi detail paket berlangganan baru untuk ditambahkan ke sistem.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                </div>
