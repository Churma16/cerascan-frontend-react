...
import { useUsers, useCreateUser } from '@/hooks/useUser.js';
...
export default function AdminUserPage() {
    ...
    return (
        <PageWrapper>
            ...
            {/* Add User Modal */}
            <AlertDialog open={isAddingUser} onOpenChange={(open) => !open && setIsAddingUser(false)}>
                <AlertDialogContent className="bg-white border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-2xl p-0 max-w-lg">
                    <div className="px-8 pt-8 border-b border-gray-100 flex items-center justify-between">
                        <AlertDialogHeader className="text-left">
                            <AlertDialogTitle className="text-2xl font-black text-[#042B1F]">
